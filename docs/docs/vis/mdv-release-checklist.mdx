...
- [ ] Publish manually from a clean local checkout using `pnpm publish:next`.
...
- [x] Issue [#56](https://github.com/Taylor-CCB-Group/SpatialData.js/issues/56) APIs: `useLayerChannelState`, `useImageLayerContext`, `ImageChannelPanel`, `getChannelSelectionStats`, Viv extension resolvers — see [MDV integration roadmap](./mdv-integration#issue-56-channel--extension-apis).
