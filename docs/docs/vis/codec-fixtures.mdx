...
0–100. Presets map to `balanced: 0.005`, `small: 0.05`.
...
qualities so you can confirm compression responds on detail-rich imagery. The main
`htj2k.zarr` fixture also uses a Mandelbrot raster instead of a smooth gradient.
